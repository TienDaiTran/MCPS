			...
			<div class="col-xs-12 col-sm-6">	
			    <form class="omb_loginForm" autocomplete="off">
					<div class="input-group">
						...
						<input id="inputEmail" type="text" class="form-control" name="txtEmail" placeholder="email address">
					</div>
					<span class="help-block"></span>
										
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-lock"></i></span>
						<input id="inputPassword" type="password" class="form-control" name="txtPassword" placeholder="Password">
					</div>
